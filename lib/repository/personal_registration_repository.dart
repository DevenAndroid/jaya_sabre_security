...
import 'package:sabre_security_app/models/ModelPersonalRegistration.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;
import '../utils/ApiConstant.dart';

Future<ModelPersonalRegistration> getpersonalInfo(
  ...
  if (response.statusCode == 200) {
    ...
    return ModelPersonalRegistration.fromJson(json.decode(response.body));
  } else {
